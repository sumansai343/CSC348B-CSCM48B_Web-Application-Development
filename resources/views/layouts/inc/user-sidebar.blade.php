            <div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark" style="background-color: cadetblue;"
                    id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="">
                            ...
                            <div class="expand {{ Request::is('user/add-post') || Request::is('user/posts') || Request::is('user/post/*') ? 'show' : '' }}"
                                id="collapsePost" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-white {{ Request::is('user/add-post') ? 'active' : '' }}"
                                        href="{{ url('user/add-post') }}">Create Blog Post</a>
                                    <a class="nav-link text-white {{ Request::is('user/posts') || Request::is('user/post/*') ? 'active' : '' }}"
                                        href="{{ url('user/posts') }}">Read Blog Post</a>
                                </nav>
                            </div>
